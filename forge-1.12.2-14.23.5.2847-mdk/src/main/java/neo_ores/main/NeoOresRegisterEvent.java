...
public class NeoOresRegisterEvent 
{
	...
	public static final int[][] COLOR_MAP = {
			{0xF8FFE8, 0xF1FFD1, 0xEAFFB9,0xE4FFA2,0xDDFF8B,0xD6FF73, 0xD0FF5C, 0xC9FF45, 0xC3FF2E, 0xBCFF17, 0xB5FF00},
			{0xF4E8FF,0xE9D1FF,0xDEB9FF,0xD3A2FF,0xC88BFF,0xBE73FF,0xB35CFF,0xA845FF, 0x9D2EFF, 0x9217FF,0x8700FF},
			{},
			{}};
	*/
	@SubscribeEvent
