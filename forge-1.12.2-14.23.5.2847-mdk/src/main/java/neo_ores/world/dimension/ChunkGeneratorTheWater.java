...
public class ChunkGeneratorTheWater  implements IChunkGenerator
{
    protected static final IBlockState MAINBLOCK = NeoOresBlocks.dim_stone.getDefaultState().withProperty(BlockDimension.DIM, DimensionName.WATER);
    protected static final IBlockState SUBBLOCK = Blocks.WATER.getDefaultState();
    ...
    public ChunkGeneratorTheWater(World worldIn, boolean p_i45637_2_, long seed)
    {
        this.world = worldIn;
