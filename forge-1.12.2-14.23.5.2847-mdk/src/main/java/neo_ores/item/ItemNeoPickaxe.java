...
public class ItemNeoPickaxe extends ItemPickaxe implements IItemNeoTool, INeoOresItem
{
    public ItemNeoPickaxe(ToolMaterial material)
    {
    	super(material);
    }
    ...
    {		
        ...
        if (this.isInCreativeTab(tab))
        {
            ...
            {
            	if(stack.getItem() instanceof ItemNeoPickaxe)
            	{
