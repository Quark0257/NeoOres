...
public class PlayerManaDataServer 
{
	...
	{
		if(value > Long.MAX_VALUE - (float)this.getMana()) this.setMana(Long.MAX_VALUE);
	...
	{
		if(value > Long.MAX_VALUE - this.getLevel()) this.setLevel(Long.MAX_VALUE);
	...
	{
		if(value > Long.MAX_VALUE - this.getTrueMaxMana()) this.setTrueMaxMana(Long.MAX_VALUE);
		else if(value + this.getTrueMaxMana() >= 0) this.setTrueMaxMana(value + this.getTrueMaxMana());
		else this.setTrueMaxMana(0);
	}
