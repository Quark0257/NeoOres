...
public class NeoOresSpells 
{
	...
	public static final SpellItem spell_harvestLv1 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest1",1,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_dig,1,2,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(1));
	public static final SpellItem spell_harvestLv2 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest2",2,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv1,1,3,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(2));
	public static final SpellItem spell_harvestLv3 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest3",3,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv2,1,4,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(3));
	public static final SpellItem spell_harvestLv4 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest4",4,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv3,1,5,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(4));
	public static final SpellItem spell_harvestLv5 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest5",5,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv4,1,6,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(5));
	public static final SpellItem spell_harvestLv6 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest6",6,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv5,1,7,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(6));
	public static final SpellItem spell_harvestLv7 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest7",7,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv6,1,8,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(7));
	public static final SpellItem spell_harvestLv8 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest8",8,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv7,1,9,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(8));
	public static final SpellItem spell_harvestLv9 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest9",9,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv8,1,10,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(9));
	public static final SpellItem spell_harvestLv10 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest10",10,SpellItemType.EARTH,1,3),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv9,1,11,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(10));
	public static final SpellItem spell_harvestLv11 = new SpellItem(new BasicData(Reference.MOD_ID,"harvest11",11,SpellItemType.EARTH,1,1000),"harvest_level",new MageKnowledgeTableData(NeoOresSpells.spell_harvestLv10,1,12,new ResourceLocation(Reference.MOD_ID,"dig"),NeoOres.neo_ores),new SpellHarvestLevel(11));
	...
	public static final SpellItem spell_tier1 = new SpellItem(new BasicData(Reference.MOD_ID,"tier1",1,SpellItemType.AIR,10,2.0F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_composition,2,2,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(1));
	public static final SpellItem spell_tier2 = new SpellItem(new BasicData(Reference.MOD_ID,"tier2",2,SpellItemType.AIR,1,2.1F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier1,2,3,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(2));
	public static final SpellItem spell_tier3 = new SpellItem(new BasicData(Reference.MOD_ID,"tier3",3,SpellItemType.AIR,1,2.2F),"tier3",new MageKnowledgeTableData(NeoOresSpells.spell_tier2,2,4,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(3));
	...
	public static final SpellItem spell_tier4 = new SpellItem(new BasicData(Reference.MOD_ID,"tier4",4,SpellItemType.AIR,1,2.3F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier3,2,5,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(4));
	public static final SpellItem spell_tier5 = new SpellItem(new BasicData(Reference.MOD_ID,"tier5",5,SpellItemType.AIR,1,2.4F),"tier5",new MageKnowledgeTableData(NeoOresSpells.spell_tier4,2,6,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(5));
	public static final SpellItem spell_tier6 = new SpellItem(new BasicData(Reference.MOD_ID,"tier6",6,SpellItemType.AIR,1,2.5F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier5,2,7,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(6));
	public static final SpellItem spell_tier7 = new SpellItem(new BasicData(Reference.MOD_ID,"tier7",7,SpellItemType.AIR,1,2.6F),"tier7",new MageKnowledgeTableData(NeoOresSpells.spell_tier6,2,8,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(7));
	public static final SpellItem spell_tier8 = new SpellItem(new BasicData(Reference.MOD_ID,"tier8",8,SpellItemType.AIR,1,2.7F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier7,2,9,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(8));
	public static final SpellItem spell_tier9 = new SpellItem(new BasicData(Reference.MOD_ID,"tier9",9,SpellItemType.AIR,1,2.8F),"tier9",new MageKnowledgeTableData(NeoOresSpells.spell_tier8,2,10,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(9));
	public static final SpellItem spell_tier10 = new SpellItem(new BasicData(Reference.MOD_ID,"tier10",10,SpellItemType.AIR,1,2.9F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier9,2,11,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(10));
	public static final SpellItem spell_tier11 = new SpellItem(new BasicData(Reference.MOD_ID,"tier11",11,SpellItemType.AIR,1,3.0F),"tier",new MageKnowledgeTableData(NeoOresSpells.spell_tier10,2,12,new ResourceLocation(Reference.MOD_ID,"composition"),NeoOres.neo_ores),new SpellTier(11));
	...
	public static final SpellItem spell_damageLv1 = new SpellItem(new BasicData(Reference.MOD_ID,"damage1",1,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_earth_damage,-2,2,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(1));
	public static final SpellItem spell_damageLv2 = new SpellItem(new BasicData(Reference.MOD_ID,"damage2",2,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv1,-2,3,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(2));
	public static final SpellItem spell_damageLv3 = new SpellItem(new BasicData(Reference.MOD_ID,"damage3",3,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv2,-2,4,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(3));
	public static final SpellItem spell_damageLv4 = new SpellItem(new BasicData(Reference.MOD_ID,"damage4",4,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv3,-2,5,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(4));
	public static final SpellItem spell_damageLv5 = new SpellItem(new BasicData(Reference.MOD_ID,"damage5",5,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv4,-2,6,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(5));
	public static final SpellItem spell_damageLv6 = new SpellItem(new BasicData(Reference.MOD_ID,"damage6",6,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv5,-2,7,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(6));
	public static final SpellItem spell_damageLv7 = new SpellItem(new BasicData(Reference.MOD_ID,"damage7",7,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv6,-2,8,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(7));
	public static final SpellItem spell_damageLv8 = new SpellItem(new BasicData(Reference.MOD_ID,"damage8",8,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv7,-2,9,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(8));
	public static final SpellItem spell_damageLv9 = new SpellItem(new BasicData(Reference.MOD_ID,"damage9",9,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv8,-2,10,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(9));
	public static final SpellItem spell_damageLv10 = new SpellItem(new BasicData(Reference.MOD_ID,"damage10",10,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv9,-2,11,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(10));
	public static final SpellItem spell_damageLv11 = new SpellItem(new BasicData(Reference.MOD_ID,"damage11",11,SpellItemType.FIRE,1,3),"damage_level",new MageKnowledgeTableData(NeoOresSpells.spell_damageLv10,-2,12,new ResourceLocation(Reference.MOD_ID,"damage"),NeoOres.neo_ores),new SpellDamageLevel(11));
