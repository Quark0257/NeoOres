...
public class BlockFluidNeoOres extends BlockFluidBase
{
    ...
    public BlockFluidNeoOres(Fluid fluid, Material material, MapColor mapColor)
    {
    ...
    public BlockFluidNeoOres(Fluid fluid, Material material)
    {
        this(fluid, material, material.getMaterialMapColor());
    }

    public BlockFluidNeoOres setFluidStack(FluidStack stack)
    {
        this.stack = stack;
        return this;
    }

    public BlockFluidNeoOres setFluidStackAmount(int amount)
    {
    ...
    public void updateTick(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull Random rand)
    {
        ...
        if (quantaRemaining < quantaPerBlock)
        {
            ...
            else if (verticalFlow(world, pos))
            {
    ...
    {
        int quantaRemaining = getEffectiveQuanta0(world, pos);
    ...
    private boolean verticalFlow(IBlockAccess world, BlockPos pos)
    {
        return world.getBlockState(pos.down(densityDir)).getBlock() == this;
    }
    
    private int getEffectiveQuanta0(IBlockAccess world, BlockPos pos)
    {
        int quantaValue = getQuantaValue(world, pos);
        return quantaValue > 0 && quantaValue < quantaPerBlock && verticalFlow(world, pos) ? quantaPerBlock : quantaValue;
    }
}
