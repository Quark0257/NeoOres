...
{
	public ParticleNoGravity(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn,int color,int time,float size,TextureAtlasSprite texture)
    {
