...
public class ChunkGeneratorTheFire implements IChunkGenerator
{
    ...
    protected static final IBlockState MAINBLOCK = NeoOres.dim_stone.getDefaultState().withProperty(BlockDimension.DIM, DimensionName.FIRE);
    ...
    public ChunkGeneratorTheFire(World world, boolean isGeneratingStructure, long seed)
    {
        ...
        this.lperlinNoise1 = new NoiseGeneratorOctaves(this.rand, 18);
