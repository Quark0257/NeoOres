...
{	
    ...
    {
		if(state.getBlock() == NeoOresBlocks.custom_lit_redstone_ore) return new ItemStack(NeoOresBlocks.custom_redstone_ore,1,this.getMetaFromState(state));
    ...
    private void activate(World worldIn, BlockPos pos)
    {
        ...
        if(this == NeoOresBlocks.custom_redstone_ore) worldIn.setBlockState(pos,NeoOresBlocks.custom_lit_redstone_ore.getDefaultState().withProperty(DIM, worldIn.getBlockState(pos).getValue(DIM)));
    }

    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
    	if(state.getBlock() == NeoOresBlocks.custom_lit_redstone_ore) worldIn.setBlockState(pos,NeoOresBlocks.custom_redstone_ore.getDefaultState().withProperty(DIM, worldIn.getBlockState(pos).getValue(DIM)));
    }
