	...
	private void onDisplay(World worldIn ,BlockPos pos,EntityLivingBase runner)
	{
        for (int i = 0; i < 12; ++i)
        {
            ...
            for(int j = 0;j < 4;j++)
            {
            	...
            	ParticleNoGravity png = new ParticleNoGravity(worldIn, start.x, start.y, start.z, velocity.x / d, velocity.y / d, velocity.z / d, 0xFFFFFF, d,0.02F,this.getTexture(worldIn.rand.nextInt(4)));
