...
public class MapGenFireStructure extends MapGenStructure
{
    private final int spacing = 30;
    private final int separation = 11;

    public MapGenFireStructure() {}

    public String getStructureName()
    {
        return "MichaSanctuary";
    }
    ...
    {
        return new FireStructureStart(this.world, this.rand, chunkX, chunkZ);
    }
