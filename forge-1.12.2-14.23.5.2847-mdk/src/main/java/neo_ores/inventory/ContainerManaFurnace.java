...
public class ContainerManaFurnace extends Container
{
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			{
				if (itemstack1.getItem() instanceof IItemNeoTool || itemstack1.getItem() instanceof ItemNeoArmor)
				{
				...
				else if (itemstack1.getItem() == NeoOresItems.air_essence_core)
				{
				...
				else if (itemstack1.getItem() == NeoOresItems.fire_essence_core)
				{
					if (!this.mergeItemStack(itemstack1, 0, 6, false))
					{
						return ItemStack.EMPTY;
				...
				else if (itemstack1.getItem() == NeoOresItems.water_essence_core)
				{
					if (!this.mergeItemStack(itemstack1, 0, 6, false))
					{
						return ItemStack.EMPTY;
				...
				else if (itemstack1.getItem() == NeoOresItems.earth_essence_core)
				{
					if (!this.mergeItemStack(itemstack1, 0, 6, false))
					{
						return ItemStack.EMPTY;
