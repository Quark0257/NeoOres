...
public class NeoOresTeleporter extends Teleporter
{
	...
	public boolean placeInExistingPortal(Entity entityIn, float rotationYaw)
	{
		if (entityIn.dimension == NeoOres.THE_WATER.getId() || entityIn.dimension == NeoOres.THE_EARTH.getId() || entityIn.dimension == NeoOres.THE_AIR.getId()
				|| entityIn.dimension == NeoOres.THE_FIRE.getId() || entityIn.dimension == 0)
		{
	...
	public BlockPos makeCustomPortal(Entity entityIn, int lastDim)
	{
			...
			for (x = -d; x < d + 1; x++)
			{
				for (z = -(d - Math.abs(x)); z < d - Math.abs(x) + 1; z++)
				{
					for (int flagY = -1; flagY < 2; flagY += 2)
					{
						y = d - Math.abs(x) - Math.abs(z);
						y *= flagY;
						if (isSolidBlock(new BlockPos(j + x, k + y, l + z)) && !isSolidBlock(new BlockPos(j + x, k + y + 1, l + z)) && !isSolidBlock(new BlockPos(j + x, k + y + 2, l + z))
								&& !isSolidBlock(new BlockPos(j + x, k + y + 3, l + z)))
						{
							j = j + x;
							k = k + y + 1;
							l = l + z;
		...
		worldIn.setBlockState(new BlockPos(j - 1, k, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(true)).withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j - 1, k, l), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true)).withProperty(BlockPane.EAST, Boolean.valueOf(false))
				.withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j - 1, k, l + 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true)).withProperty(BlockPane.EAST, Boolean.valueOf(true))
				.withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j, k, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false)).withProperty(BlockPane.EAST, Boolean.valueOf(true))
				.withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
		worldIn.setBlockState(new BlockPos(j, k, l + 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false)).withProperty(BlockPane.EAST, Boolean.valueOf(true))
				.withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
		worldIn.setBlockState(new BlockPos(j + 1, k, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(false)).withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
		worldIn.setBlockState(new BlockPos(j + 1, k, l), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true)).withProperty(BlockPane.EAST, Boolean.valueOf(false))
				.withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j + 1, k, l + 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true))
				.withProperty(BlockPane.EAST, Boolean.valueOf(false)).withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);

		worldIn.setBlockState(new BlockPos(j - 1, k + 1, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(true)).withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j - 1, k + 1, l), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true))
				.withProperty(BlockPane.EAST, Boolean.valueOf(false)).withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j - 1, k + 1, l + 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(true))
				.withProperty(BlockPane.EAST, Boolean.valueOf(true)).withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(false)), 3);
		worldIn.setBlockState(new BlockPos(j, k + 1, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(true)).withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
		worldIn.setBlockState(new BlockPos(j, k + 1, l + 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(true)).withProperty(BlockPane.SOUTH, Boolean.valueOf(false)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
		worldIn.setBlockState(new BlockPos(j + 1, k + 1, l - 1), Blocks.IRON_BARS.getDefaultState().withProperty(BlockPane.NORTH, Boolean.valueOf(false))
				.withProperty(BlockPane.EAST, Boolean.valueOf(false)).withProperty(BlockPane.SOUTH, Boolean.valueOf(true)).withProperty(BlockPane.WEST, Boolean.valueOf(true)), 3);
	...
	private boolean canTeleport(Entity entity, BlockPos portalpos)
	{
		return (isEarthPhase() && worldIn.getBlockState(portalpos).getBlock() == NeoOresBlocks.earth_portal)
				|| (isWaterPhase() && worldIn.getBlockState(portalpos).getBlock() == NeoOresBlocks.water_portal)
				|| (isAirPhase() && worldIn.getBlockState(portalpos).getBlock() == NeoOresBlocks.air_portal)
				|| (isFirePhase() && worldIn.getBlockState(portalpos).getBlock() == NeoOresBlocks.fire_portal);
	}

	private boolean isSolidBlock(BlockPos pos)
	{
		return (worldIn.getBlockState(pos).getBlock() != null && worldIn.getBlockState(pos).getBlock() != ChunkGeneratorTheAir.SUBBLOCK.getBlock()
				&& worldIn.getBlockState(pos).getBlock() != ChunkGeneratorTheFire.SUBBLOCK.getBlock() && worldIn.getBlockState(pos).getBlock() != ChunkGeneratorTheWater.SUBBLOCK.getBlock()
				&& worldIn.getBlockState(pos).getBlock() != ChunkGeneratorTheEarth.SUBBLOCK.getBlock());
	}
