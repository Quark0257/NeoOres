...
public class NeoPortalRenderer extends TileEntitySpecialRenderer<TileEntityNeoPortal>
{
    ...
    {	
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if(this.getWorld().getBlockState(te.getPos()).getBlock() == NeoOres.air_portal)
            {
            	f3 = (RANDOM.nextFloat() * 0.5F + 0.0F) * f1;
            	f4 = (RANDOM.nextFloat() * 0.5F + 0.5F) * f1;
            	f5 = (RANDOM.nextFloat() * 0.5F + 0.4F) * f1;
            }
            else if(this.getWorld().getBlockState(te.getPos()).getBlock() == NeoOres.earth_portal)
            {
            	f3 = (RANDOM.nextFloat() * 0.5F + 0.4F) * f1;
            	f4 = (RANDOM.nextFloat() * 0.5F + 0.5F) * f1;
            	f5 = (RANDOM.nextFloat() * 0.5F + 0.0F) * f1;
            }
            else if(this.getWorld().getBlockState(te.getPos()).getBlock() == NeoOres.fire_portal)
            {
            	f3 = (RANDOM.nextFloat() * 0.5F + 0.5F) * f1;
            	f4 = (RANDOM.nextFloat() * 0.5F + 0.1F) * f1;
            	f5 = (RANDOM.nextFloat() * 0.5F + 0.0F) * f1;
            }
            else
            {
            	f3 = (RANDOM.nextFloat() * 0.5F + 0.2F) * f1;
