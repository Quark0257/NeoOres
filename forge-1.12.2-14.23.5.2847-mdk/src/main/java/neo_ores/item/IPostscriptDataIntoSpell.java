...
public interface IPostscriptDataIntoSpell 
{
	...
	/**
	 * Desc Style : NBTTagList(compound).NBTTagList(string)
	 * For example : <code> {[["tranlatekey1","format1"],["translatekey2"],["translatekey3","format2","format3"]]} </code>
	 * Example of translate : <code> "transtalekey1=This is a description of %s" </code>
	 */
