...
public class DimensionHelper
{
	...
	{
		/*
		 * WATER("water",1,0x8700FF), EARTH("earth",0,0xB5FF00), AIR("air",2,0x00FFCE),
		 * FIRE("fire",3,0xFF5200);
		 */
		WATER("water", 1, 0x8700FF, 1), EARTH("earth", 0, 0x78FF00, 3), AIR("air", 2, 0x00FFBE, 0), FIRE("fire", 3, 0xFF5000, 2);
	...
	{
		WATER("water", 1), EARTH("earth", 0), AIR("air", 2), FIRE("fire", 3), CREATIVE("creative", 4);
