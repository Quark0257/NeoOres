...
public class FireStructureStart extends StructureStart {
	
	public FireStructureStart()
    {
    }

    public FireStructureStart(World worldIn, Random random, int chunkX, int chunkZ)
    {
        super(chunkX, chunkZ);
