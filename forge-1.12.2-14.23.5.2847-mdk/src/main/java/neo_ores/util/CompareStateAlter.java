...
public class CompareStateAlter implements ICompareBlockState
{
	...
	public boolean compare(BlockPos pos, IBlockState a, IBlockState b)
	{
		...
		if (b.getBlock() == Blocks.SEA_LANTERN)
			return a.getBlock().getLightValue(a) == 15;
		if (b.getBlock() instanceof BlockEnhancedPedestal)
			return a.getBlock() instanceof BlockEnhancedPedestal;
		return a == b;
	}
}
