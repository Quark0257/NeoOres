...
public class NeoOresItems 
{
	...
	public static final ToolMaterial toolCreative = EnumHelper.addToolMaterial("tool_creative", Integer.MAX_VALUE, Integer.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE, (int)Byte.MAX_VALUE).setRepairItem(new ItemStack(NeoOresBlocks.mana_block));
	
	public static final ArmorMaterial armorUndite = EnumHelper.addArmorMaterial("armor_undite", "neo_ores:undite", 29, new int[] {5,8,10,6}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 4.0F).setRepairItem(new ItemStack(NeoOresItems.undite));
	public static final ArmorMaterial armorSalamite = EnumHelper.addArmorMaterial("armor_salamite", "neo_ores:salamite", 23, new int[] {3,7,9,4}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.2F).setRepairItem(new ItemStack(NeoOresItems.salamite));
	public static final ArmorMaterial armorSylphite = EnumHelper.addArmorMaterial("armor_sylphite", "neo_ores:sylphite", 45, new int[] {2,6,7,3}, 16, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.6F).setRepairItem(new ItemStack(NeoOresItems.sylphite));
	public static final ArmorMaterial armorGnomite = EnumHelper.addArmorMaterial("armor_gnomite", "neo_ores:gnomite", 36, new int[] {6,11,13,6}, 13, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F).setRepairItem(new ItemStack(NeoOresItems.gnomite_ingot));
	...
	public static final Item mana_wrench = new ItemManaWrench()
			.setRegistryName(Reference.MOD_ID, "mana_wrench")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("mana_wrench");
	public static final Item recipe_sheet = new ItemRecipeSheet()
			.setRegistryName(Reference.MOD_ID, "recipe_sheet")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("recipe_sheet");
	public static final Item spell_sheet = new ItemSpellSheet()
			.setRegistryName(Reference.MOD_ID, "spell_sheet")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("spell_sheet");
	
	public static final Item mob_bottle = new ItemMobBottle(false)
			.setRegistryName(Reference.MOD_ID, "mob_bottle")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("mob_bottle");
	
	public static final Item mob_bottle_master = new ItemMobBottle(true)
			.setRegistryName(Reference.MOD_ID, "mob_bottle_boss")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("mob_bottle_boss");
	public static final Item undite_axe = new ItemNeoAxe(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_axe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_axe");
	public static final Item undite_hoe = new ItemNeoHoe(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_hoe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_hoe");
	public static final Item undite_paxel = new ItemNeoPaxel(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_paxel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_paxel");
	public static final Item undite_pickaxe = new ItemNeoPickaxe(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_pickaxe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_pickaxe");
	public static final Item undite_shovel = new ItemNeoSpade(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_shovel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_shovel");
	public static final Item undite_sword = new ItemNeoSword(NeoOresItems.toolUndite)
			.setToolType(ToolType.WATER)
			.setRegistryName(Reference.MOD_ID, "undite_sword")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("undite_sword");
	public static final Item salamite_axe = new ItemNeoAxe(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_axe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_axe");
	public static final Item salamite_hoe = new ItemNeoHoe(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_hoe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_hoe");
	public static final Item salamite_paxel = new ItemNeoPaxel(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_paxel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_paxel");
	public static final Item salamite_pickaxe = new ItemNeoPickaxe(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_pickaxe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_pickaxe");
	public static final Item salamite_shovel = new ItemNeoSpade(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_shovel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_shovel");
	public static final Item salamite_sword = new ItemNeoSword(NeoOresItems.toolSalamite)
			.setToolType(ToolType.FIRE)
			.setRegistryName(Reference.MOD_ID, "salamite_sword")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("salamite_sword");
	public static final Item gnomite_axe = new ItemNeoAxe(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_axe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_axe");
	public static final Item gnomite_hoe = new ItemNeoHoe(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_hoe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_hoe");
	public static final Item gnomite_paxel = new ItemNeoPaxel(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_paxel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_paxel");
	public static final Item gnomite_pickaxe = new ItemNeoPickaxe(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_pickaxe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_pickaxe");
	public static final Item gnomite_shovel = new ItemNeoSpade(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_shovel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_shovel");
	public static final Item gnomite_sword = new ItemNeoSword(NeoOresItems.toolGnomite)
			.setToolType(ToolType.EARTH)
			.setRegistryName(Reference.MOD_ID, "gnomite_sword")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("gnomite_sword");
	public static final Item sylphite_axe = new ItemNeoAxe(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_axe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_axe");
	public static final Item sylphite_hoe = new ItemNeoHoe(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_hoe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_hoe");
	public static final Item sylphite_paxel = new ItemNeoPaxel(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_paxel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_paxel");
	public static final Item sylphite_pickaxe = new ItemNeoPickaxe(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_pickaxe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_pickaxe");
	public static final Item sylphite_shovel = new ItemNeoSpade(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_shovel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_shovel");
	public static final Item sylphite_sword = new ItemNeoSword(NeoOresItems.toolSylphite)
			.setToolType(ToolType.AIR)
			.setRegistryName(Reference.MOD_ID, "sylphite_sword")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("sylphite_sword");
	public static final Item creative_axe = new ItemNeoAxe(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
			.setRegistryName(Reference.MOD_ID, "creative_axe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("creative_axe");
	public static final Item creative_hoe = new ItemNeoHoe(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
			.setRegistryName(Reference.MOD_ID, "creative_hoe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("creative_hoe");
	public static final Item creative_paxel = new ItemNeoPaxel(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
			.setRegistryName(Reference.MOD_ID, "creative_paxel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("creative_paxel");
	public static final Item creative_pickaxe = new ItemNeoPickaxe(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
			.setRegistryName(Reference.MOD_ID, "creative_pickaxe")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("creative_pickaxe");
	public static final Item creative_shovel = new ItemNeoSpade(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
			.setRegistryName(Reference.MOD_ID, "creative_shovel")
			.setCreativeTab(NeoOres.neo_ores_tab)
			.setUnlocalizedName("creative_shovel");
	public static final Item creative_sword = new ItemNeoSword(NeoOresItems.toolCreative)
			.setToolType(ToolType.CREATIVE)
	...
	public static final List<Item> registry = Arrays.asList(
			undite,
			gnomite_ingot,
			salamite,
			sylphite,
